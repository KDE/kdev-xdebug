...
K_EXPORT_PLUGIN(KDevXDebugDebuggerFactory(KAboutData("kdevxdebug", "kdevxdebug", ki18n("XDebug Support"), "1.0 Beta 1", ki18n("Support for debugging Php scripts in XDebug"), KAboutData::License_GPL)
